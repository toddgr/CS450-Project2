...
const char *WINDOWTITLE = { "OpenGL / Project #2 -- Grace Todd" };
...
Display()
{
	...
	if (WhichPOV == INSIDE) {
		gluLookAt(-0.4, 1.8, -4.9, -0.4, 1.8, -14, 0., 1., 0.);
	}
	else {
		gluLookAt(9., 1., -12.,	 0., 0., -5.,	0., 1., 0.);
		// rotate the scene:
